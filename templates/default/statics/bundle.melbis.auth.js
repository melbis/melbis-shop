    ...
    $.post(melbis_page_mod,        
        ...
        {                                                    
            ...
            {      
                bootbox.alert({
                    title: 'Access denied',
                    message: 'Sorry, you do not have access to this module!'                        
                })                                             
            }
            ...
            {      
                bootbox.alert({
                    ...
                    message: 'Sorry, but login or password is incorrect!'                        
                })                                             
            }     
...
function melbis_init_table()
{
    ...
    { field: 'amount', title: 'Amount goods', sortable: true, align: 'right' },
    ];           
