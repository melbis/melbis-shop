...
{
    MELBIS_halt('SHOP LOCKED', __FILE__.':'.__LINE__, 'Shop locked!', 'shop.lock');
} 
...
// Melbis loader
if ( !function_exists('MELBIS_autoload') ) 
{
    function MELBIS_autoload($mClassName)
    {                
    ...
    spl_autoload_register('MELBIS_autoload');
}

/** 
 * Function MELBIS
 * Connect to DB and create Parser pointer
 **/    
function MELBIS() 
{
    static $parser = false;
