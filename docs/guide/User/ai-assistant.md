...
On connection, the assistant reports how many open tasks are waiting for you in the "[Scheduler](planner.md)", counted by state — if you have the right to the scheduler. How often to look into it after that, it will ask once and remember the answer.
